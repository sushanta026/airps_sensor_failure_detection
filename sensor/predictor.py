import os,sys
from sensor.entity.config_entity import TARNSFORMER_OBJECT_FILE_NAME, MODEL_FILE_NAME, TARGET_ENCODER_FILE_NAME
...
class ModelResolver:
    ...
    def get_latest_transformer_path(self):
        try:
            ...
            return os.path.join(latest_dir,self.transformer_dir_name, TARNSFORMER_OBJECT_FILE_NAME)
        except Exception as e:
            raise e
